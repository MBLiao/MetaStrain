...
if __name__ == '__main__':
    ...
    wildSolution_moma = Wild_Growth_AA(ecYeast)
    ecYeast.objective = 'r_artemisinic_acid_sys'
    print(ecYeast.optimize())
    ecYeast.reactions.get_by_id('r_2111').lower_bound = 0.0001
    ecYeast.reactions.get_by_id('r_artemisinic_acid_sys').lower_bound = 0.05
    # ecYeast.reactions.get_by_id('r_1714_REV').lower_bound = 0.1
    # ecYeast.reactions.get_by_id('r_1761_REV').lower_bound = 0.1

    print(ecYeast.reactions.get_by_id('r_2111').bounds)
    print(ecYeast.reactions.get_by_id('SK_artemisinic_acid').bounds)
    print(ecYeast.reactions.get_by_id('r_artemisinic_acid_sys').bounds)
    print(ecYeast.reactions.get_by_id('r_1714_REV').bounds)
    print(ecYeast.reactions.get_by_id('r_1761_REV').bounds)

    wildYield = wildSolution_moma.fluxes['r_artemisinic_acid_sys'] / wildSolution_moma.fluxes['r_1761_REV']
    ...
    all_solution.to_csv("all_ref_check.csv", header=False, index=True)
    ...
    ecFSEOF_tabel = pd.read_csv("./models/dimensionality_reduction/ecFSEOF_MAPPING_AA.csv")
    ...
    while time_iter <= totalTime:
        ...
        valParents = evaluate(popold, ecYeast, ecFSEOF_tabel, GeneProteinMap,
                              'r_artemisinic_acid_sys', wildSolution_moma, metabolic_solution)
        # print(valParents)
    ...
    df_ind.to_csv("JADE_ind_AA.csv", index=False)
    df_val.to_csv("JADE_val_AA.csv", index=False)
