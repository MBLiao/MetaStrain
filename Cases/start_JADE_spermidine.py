...
if __name__ == '__main__':
    ...
    while time_iter <= totalTime:
        ...
        valParents = evaluate(popold, ecYeast, ecFSEOF_tabel, GeneProteinMap,
                              'r_2051', wildSolution_moma, metabolic_solution)
        # print(valParents)
    ...
    df_ind.to_csv(r"C:\Users\Wenb1n\Desktop\expdata\JADE_ind_sp.csv", index=False)
    df_val.to_csv(r"C:\Users\Wenb1n\Desktop\expdata\JADE_val_sp.csv", index=False)
